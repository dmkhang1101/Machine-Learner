...
with open('cancer.csv') as csvfile:
    for row in csvfile:
        cancer.append(row.strip().split())
...
attributes_cancer = cancer[0][:-1]
cancer = cancer[1:]
attributes_cancer_type = [True]*len(attributes_cancer)
attributes_cancer_value = ["numerical"]*len(attributes_cancer)
...
ten_folds_cancer = construct_10_folds(cancer,['0','1'],-1)
...
resulting_accuracy_cancer = []
resulting_precision_cancer = []
resulting_recall_cancer = []
resulting_f1_cancer = []
...
for value in ntree:
    ...
    result_cancer = random_forest(value,ten_folds_cancer,attributes_cancer,attributes_cancer_type,attributes_cancer_value,['0','1'],-1)
    resulting_accuracy_cancer.append(result_cancer[0])
    resulting_precision_cancer.append(result_cancer[1])
    resulting_recall_cancer.append(result_cancer[2])
    resulting_f1_cancer.append(result_cancer[3])
    print("accuracy " + str(result_cancer[0]))
    print("finish" + " "+ str(value)+" trees")
...
# figure, axis = plt.subplots(nrows = 1, ncols = 4, figsize = (20,5))

# axis[0].plot(ntree,resulting_accuracy_cancer)
# axis[0].set_title("Accuracy of Breast Cancer Dataset")
# axis[0].set_xlabel("Value of Ntree")
# axis[0].set_ylabel("Accuracy of Breast Cancer")

# axis[1].plot(ntree,resulting_precision_cancer)
# axis[1].set_title("Precision of Breast Cancer Dataset")
# axis[1].set_xlabel("Value of Ntree")
# axis[1].set_ylabel("Precision of Breast Cancer")

# axis[2].plot(ntree,resulting_recall_cancer)
# axis[2].set_title("Recall of Breast Cancer Dataset")
# axis[2].set_xlabel("Value of Ntree")
# axis[2].set_ylabel("Recall of Breast Cancer")

# axis[3].plot(ntree,resulting_f1_cancer)
# axis[3].set_title("F1 of Breast Cancer Dataset")
# axis[3].set_xlabel("Value of Ntree")
# axis[3].set_ylabel("F1 of Breast Cancer")
